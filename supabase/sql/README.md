...
- **Migrations** keep a single, ever-increasing number across all sprints. S2 used `0001`–`0007`,
  S3 added `0008`, S4 added `0009`–`0010`, S5 (content schema) added `0011`–`0015`; the next
  database sprint continues at `0016`. Never reuse or renumber. Once a migration has been applied to production it is **immutable** — a correction
