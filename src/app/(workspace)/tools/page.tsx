    ...
    >
      <Reveal>
        ...
        <p className="ws-lead" style={{ marginInline: "auto" }}>
          Partner tools that help you run a House — arriving in stages.
          We&rsquo;re building these carefully; nothing here yet.
        </p>
        ...
        >
          When they&rsquo;re ready, you&rsquo;ll find them here. For now,
          everything you need is in your{" "}
          <Link className="ws-link" href="/plan">Stages</Link>,{" "}
